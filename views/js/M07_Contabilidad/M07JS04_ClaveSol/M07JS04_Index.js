...
function Control() {
    ...
    $('#bxFiltroProyectoPC').change(function () {
        ...
        var url = '../../models/M07_Contabilidad/M07MD04_ClaveSol/M07MD04_Procesos.php';
        var datos = {
            "ListarZonas": true,
...
function VerTipoCambio() {  
    ...
    $.ajax({
      type: "POST",
      url: "../../models/M07_Contabilidad/M07MD04_ClaveSol/M07MD04_Procesos.php",
      data: data,
      dataType: "json",
...
function LlenarTablaPagosComprobanteReporte() {
    var options = $.extend(true, {}, defaults, {
        ...
        "ajax": {
            "url": "../../models/M07_Contabilidad/M07MD04_ClaveSol/M07MD04_Procesos.php", // ajax source
            "type": "POST",
...
function EnviarAdjuntoPago(nombre){
    ...
    var file_data = $('#ComprobanteCV').prop('files')[0];   
     ...
     //alert(form_data);                             
     $.ajax({
         url: '../../models/M07_Contabilidad/M07MD04_ClaveSol/M07MD04_SubirComprobante.php', // point to server-side PHP script 
	...
	$.ajax({
		...
		success: function (dato) {
			...
			if (dato.status == "ok") {
                ...
                $("#cbxConceptos").val(resultado.id_concepto);
