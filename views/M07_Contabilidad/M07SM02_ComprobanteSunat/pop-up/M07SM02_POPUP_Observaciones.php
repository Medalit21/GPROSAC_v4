<div class="modal-dialog modal-sm modal-dialog-centered" role="document">
    ...
    <div class="modal-content">
        ...
        <div class="head-model cabecera-modal-accion">
            <button class="btn btn-model-success" id="btnGuardarObservacion"><i class="fas fa-save"></i> Observar</button>
            <button class="btn btn-model-success" id="btnConforme"><i class="fas fa-check"></i> Conforme</button>
        </div>
        <div class="modal-body">
            <div class="form-row">
                ...
                <div class="col-md-12">
                    ...
                    <textarea rows="4" maxlength="100" id="txtObservacion" class="caja-texto"  placeholder="Describa el motivo" style="height: auto;resize: none;" required></textarea>
                </div>
                <div class="col-md-12">
