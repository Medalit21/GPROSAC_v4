...
<body class="fond-back">
        ...
        <div class="page-wrapper">
            ...
            <div class="breadcrumb-ancho mt-1">
                <ol class="breadcrumb breadcrumb-arrow">
                    <li><a class="enlace" href="javascript:void(0)">Clave Sol</a></li>
                    <li><a class="enlace" href="javascript:void(0)">Validar Pago-Comprobante</a></li>
            ...
            <div class="container-fluid pt-0">
                <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" href="#PagoComprobante" role="tab" data-toggle="tab">Pago - Comprobante</a>
                    </li>
                    <!--<li class="nav-item">
                        <a class="nav-link" href="#ReservaComprobante" role="tab" data-toggle="tab">Reserva - Comprobante</a>
                    </li>-->
                </ul>
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane fade in active" id="PagoComprobante" style="opacity: 1;">
                        ...
                        <div id="contenido_lista">
                            ...
                            <div class="form-row mt-3 col-md-12">
                                ...
                                <div class="col-md-2">
                                    <label class="label-texto">Estado Facturaci&oacute;n Pago</label>
                                    <select id="cbxFiltroEstadoPC" class="cbx-texto">
                                        <option selected="true" value="">TODOS</option>
                                        <?php
                                        $EstadoFac = new ControllerCategorias();
                                        $EstadoFacVer = $EstadoFac->VerEstadoFacturacionPago();
                                        foreach ($EstadoFacVer as $Estado) {
                                        ?>
                            ...
                            <div class="form-row mt-3 col-md-12">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select id="cbxFiltroProyectoPC" class="cbx-texto">
                                        <?php
                                ...
                                <div class="col-md-2">
                                    ...
                                    <select id="bxFiltroZonaPC" class="cbx-texto">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <select id="bxFiltroManzanaPC" class="cbx-texto">
                                        <option selected="true" disabled="disabled" value="">Seleccionar...</option>
                                    </select>
                                </div>
                                ...
                                <div class="col-md-2">
                                    ...
                                    <select id="bxFiltroLotePC" class="cbx-texto">
                                        <option selected="true" disabled="disabled" value="">Seleccionar...</option>
                                    </select>
                                </div>
                                
                                <div class="col-md-2">
                                    <label class="label-texto">Estado Validaci&oacute;n Pago</label>
                                    <select id="cbxFiltroEstadoValPC" class="cbx-texto">
                                        <option selected="true" value="">TODOS</option>
                                        <?php
                                        $EstadoFac = new ControllerCategorias();
                                        $EstadoFacVer = $EstadoFac->VerEstadoValidacionPago();
                                        foreach ($EstadoFacVer as $Estado) {
                                        ?>
                                        <option value="<?php echo $Estado['ID']; ?>">
                                        <?php echo $Estado['Nombre']; ?>
                                ...
                                <div class="table-responsive scroll-table">
                                    <table class="table table-striped table-bordered table-hover w-100" id="TablaPagoComprobanteReporte" style="display: none;">
                                        <thead class="cabecera">
                                            <tr>
                                                <th>Estado Facturaci&oacute;n</th>
                                                <th>Fecha Pago</th>
                                                <th>Cliente</th>
                                                <th>Lote</th>
                            ...
                            <fieldset class="text-center">
                                <div class="form-row col-md-12 text-center">
                                    <div class="col-md-1">
                                        <label class="label-texto font-weight-bold">LEYENDA</label>
                                    </div>
                                    <div class="col-md-2">
                                        <label class="label-texto"><i class="fas fa-paperclip" style="color: blue"></i> : Cargar Comprobantes</label>
                                    </div>
                                    
                                    <div class="col-md-2">
                                        <label class="label-texto"><i class="fas fa-file" style="color: blue"></i> : Ver Voucher de Pago</label>
                                    </div>
        
                                    <div class="col-md-2">
                                        <label class="label-texto"><i class="fas fa-folder-open" style="color: blue"></i> : Ver Comprobantes</label>
                                    </div>
                                    
                                    <div class="col-md-2">
                                        <label class="label-texto"><i class="fas fa-check" style="color: green"></i> : Finalizar pago</label>
                                    </div>
                                    
                                    <div class="col-md-1">
                                        <label class="label-texto"><i class="fas fa-exclamation" style="color: orange"></i> : Observar Pago</label>
                                    </div>
                                    
                                    <div class="col-md-2">
                                        <label class="label-texto"><i class="fas fa-redo" style="color: orange"></i> : Anular Finalizar Pago</label>
                                    </div>
                                </div>
                            </fieldset>
                    ...
                    <div role="tabpanel" class="tab-pane fade in" id="ReservaComprobante" style="opacity: 1;">
                        <div class="box box-primary">
                            <div id="contenido_lista">
                                <br>
                                <div class="col-md-12">
                                ...
                                <div class="form-row mt-3 col-md-12">
                                    ...
                                    <div class="col-md-4">
                                        <label class="label-texto">Cliente</label>
                                        <select id="txtFiltroDocumentoCVR" style="width: 100%; font-size: 11px;" class="cbx-texto">
                                            <option selected="true" value="" disabled="disabled">TODOS</option>
                                            <?php
                                            $Clientes = new ControllerCategorias();
                                            $ClientesVer = $Clientes->VerClientesBusqueda();
                                    ...
                                    <div class="col-md-2">
                                        <label class="label-texto">Desde</label>
                                        <input type="date" id="txtFiltroDesdeCVR" class="caja-texto">
                                    </div>
                                    <div class="col-md-2">
                                        <label class="label-texto">Hasta</label>
                                        <input type="date" id="txtFiltroHastaCVR" class="caja-texto">
                                    </div>
                                    
                                    <div class="col-md-2">
                                        <label class="label-texto">Agencia Bancaria</label>
                                        <select id="cbxFiltroBancoCVR" class="cbx-texto">
                                            <option selected="true" value="">TODOS
                                            </option>
                                            <?php
                                            $VerBanco = new ControllerCategorias();
                                    ...
                                    <div class="col-md-2">
                                        <label class="label-texto">Estado Facturaci&oacute;n Pago</label>
                                        <select id="cbxFiltroEstadoPCR" class="cbx-texto">
                                            <option selected="true" value="">TODOS</option>
                                            <?php
                                            $EstadoFac = new ControllerCategorias();
                                            $EstadoFacVer = $EstadoFac->VerEstadoFacturacionPago();
                                ...
                                <div class="form-row d-flex justify-content-center">
                                    <div class="col-md-4 text-center mt-1">
                                        <button class="btn btn-registro-success" id="btnBuscarRegistroCVR" name="btnBuscarRegistroCV"><i class="fas fa-search"></i> Buscar</button>
                                        <button class="btn btn-registro-primary" id="btnLimpiarCVR" name="btnLimpiarCV"><i class="fas fa-sync-alt"></i> Limpiar</button>
                                    </div>
                                </div>
                                <br>
                                <!-- TABLA CONTENEDORA DE REGISTRO DE TRABAJADORES -->
                                <div class="fn-frm-dt">
                                    <div class="table-responsive scroll-table">
                                        <table class="table table-striped table-bordered table-hover w-100" id="TablaPagoComprobanteReporteR" style="display: none;">
                                            <thead class="cabecera">
                                                <tr>
                                                    <th>Estado Facturaci&oacute;n</th>
                                                    <th>Fecha Pago</th>
                                        ...
                                        <br><br>
                                        <table class="table table-striped table-bordered table-hover w-100" id="TablaPagoComprobanteR">
                                            <thead class="cabecera">
                                                <tr>
                                                    <th>Acciones</th>
                                                    <th>Estado Facturaci&oacute;n</th>
    ...
    <script src="../../js/M07_Contabilidad/M07JS04_ClaveSol/M07JS04_Index.js?v=1.2.0"></script>
