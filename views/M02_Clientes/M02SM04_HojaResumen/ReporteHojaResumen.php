                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <center><label style="font-size: 18px; text-align: center; font-weight: bold;">HOJA RESUMEN</label></center>
                                <br>
                                ...
                                gpv.estado_devolucion as devolucion_estado,
                                ...
                                if(gpv.cancelado=1,'0.00',format((SELECT if(SUM(gpcr.monto_letra)>0,SUM(gpcr.monto_letra),0) FROM gp_cronograma gpcr WHERE gpcr.id_venta=gpv.id_venta AND gpcr.estado=1 AND gpcr.esta_borrado='0'),2)) as letras_pendientes
                                ...
                                $letras_pagadas = $respuesta_datos['cont_pagadas'];
                                ...
                                $devolucion_estado = $respuesta_datos['devolucion_estado'];

                                $ocultar_etiqueta = 'style="display: none;"';
                                $etiqueta_estado = "";
                            	if($cancelado=='1'){
                            	   $ocultar_etiqueta = ""; 
                                   $etiqueta_estado = "C A N C E L A D O";
                            	}else{
                            	   $ocultar_etiqueta = 'style="display: none;"';
                            	}
                            	...
                            	$ocultar_etiqueta = 'style="display: none;"';
                            	if($devolucion=='1'){
                            	   if($devolucion_estado == '2'){
                                        $ocultar_etiqueta = '';
                                        $etiqueta_estado = "DEVOLUCIÓN PENDIENTE DE PAGO";
                                   }else{
                                        if($devolucion_estado == '3'){
                                            $ocultar_etiqueta = '';
                                            $etiqueta_estado = "D E V U E L T O";
                                        }
                                   }
                            	}else{
                            	   $ocultar_etiqueta = 'style="display: none;"';
                                ...
                                $consultar_cancelado = mysqli_query($conection, "select gpv.cancelado as cancelado 
                                from  gp_venta gpv
                                INNER JOIN datos_cliente AS dc ON dc.id=gpv.id_cliente
                                WHERE dc.documento='$valor' $query_lote $query_venta");
                                $respuesta_cancelado = mysqli_fetch_assoc($consultar_cancelado);
                                $cancelado = $respuesta_cancelado['cancelado'];
                                
                                $consultar_total1 = mysqli_query($conection, "select (sum(gppd.pagado) + if((select sum(monto_letra) from gp_cronograma where id_venta=gpv.id_venta AND dscto_acuerdo='1')>0,(select sum(monto_letra) from gp_cronograma where id_venta=gpv.id_venta AND dscto_acuerdo='1'),0)) as total 
                                from gp_pagos_cabecera gppc 
                                INNER JOIN gp_pagos_detalle AS gppd ON gppd.idpago=gppc.idpago AND gppd.esta_borrado='0'
                                ...
                                $total_pagado_letras = number_format($total_1, 2, '.', ',');
                                
                                $consultar_total2 = mysqli_query($conection, "select sum(gpcr.monto_letra) as total from gp_cronograma gpcr 
                                ...
                                if($cancelado == '1'){
                                    $total_por_cancelar = "0.00";
                                }else{
                                    
                                    $tot_cal_cancelar = $total_2 - $total_1;
                                ...
                                <div class="table-responsive">
                                    <table style="width: 100%">
                                        <tr>
                                            <th style="background-color: #7BB1FF; color: white; width: 200px; font-size: 11px"><b><?php echo $dato; ?></b></th>
                                            <th style="background-color: #7BB1FF; color: white; width: 180px; font-size: 12px;margin-left: 1%"><b>Contacto : </b><?php echo $contacto; ?></th>
                                            <th style="background-color: #7BB1FF; color: white; width: 230px; font-size: 12px;margin-left: 1%"><b>Precio Pactado : $ </b><?php echo $precio_pactado; ?></th>
                                        </tr>
                                        <tr>
                                            <th style="font-size: 12px"><b>Lote : </b><?php echo $lote; ?></th>
                                            <th style="font-size: 12px"><b>Importe Inicial : $ </b><?php echo $importe_inicial; ?></th>
                                            <th style="font-size: 12px"><b>Importe Financiado : $ </b><?php echo $importe_financiado; ?></th>
                                        </tr>
                                        <tr>
                                            <th style="font-size: 12px"><b>Tipo Casa : </b> <?php echo $tipo_casa; ?></th>
                                            <th style="font-size: 12px"><b>Saldo Inicial : $ </b><?php echo $saldo_inicial; ?></th>
                                            <th style="font-size: 12px"><b>Monto Pagado : $ </b><?php echo $total_pagado_letras; ?></th>
                                        </tr>
                                        <tr>
                                            <th style="font-size: 12px"><b>Fecha Entrega : </b> <?php echo $fecha_entrega; ?></th>
                                            <th style="font-size: 12px"><b>Interés : $ </b><?php echo $interes; ?></th>
                                            <th style="font-size: 12px"><b>Monto Pendiente : $ </b><?php echo $total_por_cancelar; ?></th>
                                        </tr>
                                    </table>
                                    <table style="width: 100%">
                                        <tr>
                                            <th style="background-color: #0EBF00; color: white; width: 210px; font-size: 12px"><b>Letras Pagadas : </b><?php echo $letras_pagadas.' - '.$total_pagado_letras; ?></th>
                                            <th style="background-color: #DC0000; color: white; width: 180px; font-size: 12px"><b>Letras Vencidas : </b><?php echo $letras_vencidas; ?></th>
                                            <th style="background-color: #FFA342; color: white; width: 243px; font-size: 12px"><b>Letras Pendientes : </b><?php echo $letras_pendientes; ?></th>
                                        </tr>
                                    </table>
                                    <br>
                                </div>
                                ...
                                <div class="col-md-12 text-center cancel" <?php echo $ocultar_etiqueta; ?>><?php echo $etiqueta_estado; ?></div>
                                <br>
                                    ...
                                    <div class="table-responsive">
                                        <?php
                                           ...
                                           $consulta_idventa = mysqli_query($conection, "SELECT gpv.id_venta as id_venta FROM gp_venta gpv, datos_cliente dc WHERE gpv.id_cliente=dc.id AND dc.documento='$valor' $query_lote $query_venta");
                                            ...
                                            $query_ventas = mysqli_query($conection,"SELECT
                                                    ...
                                                    (select if(SUM(gppd.pagado)>0,format(SUM(gppd.pagado),2),'0.00') from gp_pagos_cabecera gppc INNER JOIN gp_pagos_detalle AS gppd ON gppd.idpago=gppc.idpago AND gppd.esta_borrado='0' INNER JOIN configuracion_detalle AS cdx ON cdx.codigo_tabla='_TIPO_MONEDA' AND cdx.idconfig_detalle=gppd.moneda_pago WHERE cdx.texto1='PEN' AND  gppc.id_venta=gpcr.id_venta AND gppc.id_cronograma=gpcr.correlativo) as monto_soles,
                                                    ...
                                                    format((SELECT if((SUM(gppd.monto_soles))>0, SUM(gppd.monto_soles),'0.00') FROM gp_pagos_cabecera gppc, gp_pagos_detalle gppd WHERE gppc.idpago=gppd.idpago AND gppc.id_cronograma=gpcr.correlativo AND gppd.esta_borrado='0' AND gppc.esta_borrado='0' AND gppc.id_venta=gpv.id_venta GROUP BY gppd.idpago),2) as soles,
                                                    format((SELECT if((SUM(gppd.monto_dolares))>0, SUM(gppd.monto_dolares),'0.00') FROM gp_pagos_cabecera gppc, gp_pagos_detalle gppd WHERE gppc.idpago=gppd.idpago AND gppc.id_cronograma=gpcr.correlativo AND gppd.esta_borrado='0' AND gppc.esta_borrado='0' AND gppc.id_venta=gpv.id_venta GROUP BY gppd.idpago),2) as dolares,
                                                    ...
                                                    (SELECT if((gppd.importe_pago)>0, gppd.nro_operacion,'Ninguno') FROM gp_pagos_cabecera gppc, gp_pagos_detalle gppd WHERE gppc.idpago=gppd.idpago AND gppc.id_cronograma=gpcr.correlativo AND gppd.esta_borrado='0' AND gppc.esta_borrado='0' AND gppc.id_venta=gpv.id_venta GROUP BY gppd.idpago) as nro_operacion,
                                                    (SELECT if((gppd.importe_pago)>0, GROUP_CONCAT(DISTINCT gppdc.serie,'-',gppdc.numero),'Ninguno') FROM gp_pagos_cabecera gppc, gp_pagos_detalle gppd, gp_pagos_detalle_comprobante gppdc WHERE gppc.id_cronograma=gpcr.correlativo AND gppc.id_venta=gpv.id_venta AND gppc.idpago=gppd.idpago AND gppd.idpago_detalle=gppdc.idpago_detalle AND gppd.esta_borrado='0' AND gppdc.esta_borrado='0') as boleta
										...
										<table class="table table-striped table-bordered" cellspacing="0" id="TablaHojaResumen" style="width: 100%; text-align: center;">
                                            <thead class="cabecera">
                                                <tr>
                                                    <th style="font-size: 11px;width: 60px">Fecha</th>
                                                    <th style="font-size: 11px">Letra</th>
                                                    <th style="font-size: 11px">Monto</th>
                                                    <th style="font-size: 11px">Soles</th>
                                                    <th style="font-size: 11px">Dolares</th>
                                                    <th style="font-size: 11px">Estado</th>
													<th style="font-size: 11px">Mora</th>
                                                    <th style="font-size: 11px;">N° Operación</th>
                                                    <th style="font-size: 11px; width: 65px">N° Boleta</th> 
                                                </tr>
                                            </thead>
                                            <tbody class="control-detalle">
                                                ...
                                                //consultar boletas
                                                $boletas = "";
                                                $consultar_boletas = mysqli_query($conection, "SELECT if((gppd.pagado)>0, GROUP_CONCAT(DISTINCT gppdc.serie,'-', CAST(gppdc.numero as int) SEPARATOR ' / '),'Ninguno') as boleta 
                                                ...
                                                ?>
                                                <tr>
                                                    <td style="font-size: 9px"><?php echo $row['fecha']; ?></td>
                                                    <td style="font-size: 9px"><?php echo $row['letra']; ?></td>
                                                    <td style="font-size: 9px"><?php echo $row['monto']; ?></td>
                                                    <td style="font-size: 9px"><?php echo $row['monto_soles']; ?></td>
                                                    <td style="font-size: 9px"><?php echo $row['monto_dolares']; ?></td>
                                                    <td <?php if($row['estado']=="1"){ ?> style="color: #FFA342; font-size: 9px" <?php }else{ if($row['estado']=="2"){ ?> style="color: #0EBF00; font-size: 9px" <?php }else{ ?> style="color: #DC0000; font-size: 9px" <?php }} ?>><?php echo $row['descEstado']; ?></td>
                                                    <td style="font-size: 9px"><?php echo $row['mora']; ?></td>
                                                    <td style="font-size: 9px"><?php echo $nro_operacion; ?></td>
                                                    <td style="font-size: 9px"><?php echo $boletas; ?></td>
                                                </tr>
                                                <?php  } ?>
                                            </tbody>
                                        </table>
