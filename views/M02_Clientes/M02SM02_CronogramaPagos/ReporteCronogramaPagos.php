...
<body>
    ...
    <?php
		...
		$valor = $_GET['Dto'];
        $valor = decrypt($valor,"123"); //id lote
        
        
        $docu = $_GET['d0q'];
        $docu = decrypt($docu,"123");
		...
		if(!empty($valor)){
		    $query_lote = "AND gpv.id_lote='$valor'";
		}
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <center><label style="font-size: 18px; text-align: center; font-weight: bold;">CRONOGRAMA DE PAGOS</label></center>
                                <br>
                                ...
                                format(ROUND((SELECT SUM(pagod.pagado) FROM gp_pagos_detalle pagod, gp_pagos_cabecera pagoc, gp_cronograma gpcr 
                                WHERE pagod.idpago=pagoc.idpago AND pagoc.id_cronograma=gpcr.correlativo AND gpcr.id_venta=gpv.id_venta AND pagoc.id_venta=gpv.id_venta AND pagod.id_venta=gpv.id_venta AND gpcr.estado=2 AND gpcr.esta_borrado='0'),1),2) as monto_pagado,
                                ...
                                format(if(((select sum(gpcr.monto_letra) as total from gp_cronograma gpcr WHERE gpcr.id_venta=gpv.id_venta AND gpcr.esta_borrado='0')-(select sum(pagado) as total from gp_pagos_cabecera WHERE id_venta=gpv.id_venta AND esta_borrado='0'))<1,'0.00',((select sum(gpcr.monto_letra) as total from gp_cronograma gpcr WHERE gpcr.id_venta=gpv.id_venta AND gpcr.esta_borrado='0')-(select sum(pagado) as total from gp_pagos_cabecera WHERE id_venta=gpv.id_venta AND esta_borrado='0'))),2) as monto_pendiente,
                    			...
                    			AND dc.documento='$docu' $query_lote
                    			GROUP BY dc.id");
                                ...
                                $monto_pendiente = $respuesta_datos['letras_pendientes'];
                                $capital_vivo = $respuesta_datos['capital_vivo'];
                                ...
                                <div class="table-responsive" style="margin-left: -20px">
                                    <table style="width: 100%">
                                        <tr>
                                            <th style="background-color: #7BB1FF; color: white; width: 280px; font-size: 12px"><b><?php echo $dato; ?></b></th>
                                            <th style="background-color: #7BB1FF; color: white; width: 200px; font-size: 12px;margin-left: 1%"><b>UBICACIÓN : </b><?php echo $lote; ?></th>
                                            <th style="font-size: 11px; width: 250px"><b>PRECIO TOTAL LOTE : $ </b><?php echo $importe_financiado; ?></th>
                                        </tr>
                                    </table>
                                    <table style="width: 100%">
                                        <tr>
                                            <th style="font-size: 11px; width: 280px"><b>PRECIO DE VENTA : $ </b><?php echo $precio_pactado; ?></th>
                                            <th style="font-size: 11px; width: 200px"><b>INTERESES : $ </b><?php echo $interes; ?></th>
                                            <th style="font-size: 11px; width: 250px"><b>TIEMPO FINANCIADO : </b><?php echo $TiempoFinanciado; ?></th>
                                        </tr>
                                        <tr>
                                            <th style="font-size: 11px; width: 280px"><b>CAPITAL VIVO : $ </b> <?php echo $capital_vivo; ?></th>
                                            <th style="font-size: 11px; width: 200px"><b>SALDO PENDIENTE : </b><?php echo $monto_pendiente; ?></th>
                                            <th style="font-size: 11px; width: 250px"><b>TOTAL CANCELADO : $ </b><?php echo $monto_pagado; ?></th>
                                        </tr>
                                        <tr>
                                            <th style="width: 280px; font-size: 11px"><b>Correo : </b><?php echo $correo; ?></th>
                                            <th style="width: 200px; font-size: 11px"><b>Teléfono : </b><?php echo $contacto; ?></th>
                                            <th style="width: 250px; font-size: 11px"><b>Fecha Entrega Casa : </b><?php echo $fecha_entrega; ?></th>
                                        </tr>
                                    </table>
                                    <br>
                                </div>
                                ...
                                <div class="fn-frm-dt">                                  
                                    <div class="table-responsive">
                                        <?php
                                           ...
                                           /*$consulta_idventa = mysqli_query($conection, "SELECT gpv.id_venta as id_venta FROM gp_venta gpv, datos_cliente dc WHERE gpv.id_cliente=dc.id AND dc.documento='$valor'");
                                        	$respuesta_idventa = mysqli_fetch_assoc($consulta_idventa);
                                        	$idventa = $respuesta_idventa['id_venta'];*/
                                            
                                            $query_cronograma = mysqli_query($conection,"SELECT 
										...
										<table class="table table-striped table-bordered" cellspacing="0" id="TablaHojaResumen" style="width: 100%; text-align: center;">
                                            <thead class="cabecera">
                                                <tr>
                                                    ...
                                                    <th style="font-size: 11px">Monto Letra</th>
                                                    <th style="font-size: 11px">Intereses</th>
                                                    <th style="font-size: 11px">Amortización</th>
                                                    <th style="font-size: 11px">Capital Vivo</th>
													<th style="font-size: 11px">Total Pagado</th>
                                                    <th style="font-size: 11px">Estado</th>
                                                </tr>
                                            </thead>
                                            <tbody class="control-detalle">
                                                <?php while($row = $query_cronograma->fetch_assoc()){  ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $row['capital_vivo']; ?></td>
