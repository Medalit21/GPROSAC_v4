...
<body class="fond-back">
        ...
        <div class="page-wrapper fond-back">
            ...
            <div class="breadcrumb-ancho">
                <ol class="breadcrumb breadcrumb-arrow">
                    <li><a class="enlace" href="javascript:void(0)">Estado de Cuenta</a></li>
                </ol>
            </div>
            <!-- ============================================================== -->
            ...
            <div class="container-fluid">
                ...
                <div class="box box-primary">
                    ...
                    <div class="form-row d-flex justify-content-center">
                        <div class="col-md-6 text-center mt-1" id="PanelBotons">
                            <button id="btnBuscarEC" type="button" class="btn btn-registro-success"><i class="fas fa-search"></i> Buscar</button>
                            <button id="btnLimpiar" type="button" class="btn btn-registro-primary"><i class="fas fa-sync-alt"></i> Limpiar</button>
                            <button id="btnExportarPdf" type="button" class="btn btn-registro-danger"><i class="fas fa-file-pdf"></i> PDF</button>
                            ...
                            <div class="card-body">
                                ...
                                <div id="editor">                                   
                                     ...
                                     <div class="form-row">
                                        ...
                                        <diV class="col-md">
                                            <input type="text" class="form-control text-cronograma" id="TXT2" placeholder="UBICACION:" style="background-color: #FF8B7B; color: white" readonly>
                                        </diV>
                                    </div>
                                    <div class="form-row">
                                        <diV class="col-md">
                                            <input type="text" class="form-control text-cronograma" id="txt3campo" placeholder="PRECIO DE VENTA: 0.00" readonly>
                                        </diV>
                                        <diV class="col-md">
                                            <input type="text" class="form-control text-cronograma" id="TXT4" placeholder="INTERESES: 0.00" readonly>
                                        </diV>
                                        <diV class="col-md">
                                            <input type="text" class="form-control text-cronograma" id="TXT5" placeholder="PRECIO TOTAL DEL LOTE: 0.00" readonly>
                                        </diV>
                                        
                                    </div>
                                    <div class="form-row">
                                        <diV class="col-md">
                                            <input type="text" class="form-control text-cronograma" id="TXT6" placeholder="CAPITAL VIVO: 0.00" readonly>
                                        </diV>
                                        <diV class="col-md">
                                            <input type="text" class="form-control text-cronograma" id="TXT7" placeholder="TIEMPO DE FINANCIAMIENTO: 0.00" readonly>
                                        </diV>
                                        <diV class="col-md">
                                            <input type="text" class="form-control text-cronograma" id="TXT8" placeholder="TOTAL CANCELADO: 0.00" readonly>
                                        </diV>
                                        
                                    </div>
                                    <div class="form-row">
                                        <diV class="col-md">
                                            <input type="text" class="form-control text-cronograma" id="TXT9" placeholder="Correo: Ninguno" readonly>
                                        </diV>
                                        <diV class="col-md">
                                            <input type="text" class="form-control text-cronograma" id="TXT10" placeholder="Teléfono: Ninguno"  readonly>
                                        </diV>
                                        <diV class="col-md">
                                            <input type="text" class="form-control text-cronograma" id="TXT11" placeholder="Fecha Entrega Casa: 0000-00-00" readonly>
                                        </diV>
                                ...
                                <div class="fn-frm-dt">                                  
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered" cellspacing="0" id="TablaEstadoCuentasReporte" style="display: none; width: 100%">
										...
										<table class="table table-striped table-bordered" cellspacing="0" id="TablaEstadoCuentas" style="width: 100%">
                                            <thead class="cabecera">
                                                <tr>
                                                    <th>Fecha Vencimiento</th>
                                                    <th>Letra</th>
    ...
    <script src="../../js/M02_Clientes/M02JS03_EstadoCuenta/M02JS03_EstadoCuenta.js?v=1.1.1"></script>
