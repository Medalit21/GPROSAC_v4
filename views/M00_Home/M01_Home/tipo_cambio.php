...
<body class="fond-back">
        ...
        <div class="page-wrapper">
            ...
            <div class="breadcrumb-ancho mt-1">
                <ol class="breadcrumb breadcrumb-arrow">
                    <li><a class="enlace" href="javascript:void(0)">Tipo de Cambio</a></li>
            ...
            <div class="container-fluid pt-0">
                ...
                <!-- Start Page Content -->
                <!-- ============================================================== -->
                <div class="row" id="contenido_lista">
                    <div class="col-md-6">
                        <div class="card">
                            <form class="form-horizontal">
                                <div class="card-body">
                                    <h4 class="card-title">Registrar Nuevo</h4>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="date" class="form-control" id="txtFechaTC" placeholder="First Name Here">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="lname" class="col-sm-3 text-right control-label col-form-label">Valor</label>
                                        <div class="col-md-9">
                                            <input type="number" class="form-control" id="txtValorTC" placeholder="Ejm: 3.81">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="lname" class="col-sm-3 text-right control-label col-form-label">Hoy, </label>
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" id="txtRegistroTC">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="email1" class="col-sm-3 text-right control-label col-form-label">Referencia</label>
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" id="txtReferenciaTC" value="SBS" readonly>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title m-b-0">Historial</h5>
                                <!-- TABLA CONTENEDORA DE REGISTRO DE TRABAJADORES -->
                                <div class="fn-frm-dt">
                                    <div class="table-responsive scroll-table">
                                        <table class="table table-striped table-bordered table-hover w-100" id="TablaTipoCambio">
    ...
    <script src="../../js/Home/tipo_cambio.js?v=1.2.0"></script>
