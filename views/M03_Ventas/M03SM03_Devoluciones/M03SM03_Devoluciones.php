...
<body>
    ...
    <div id="main-wrapper">
				...
				<div class="box box-primary">                  
					<div id="BusquedaVenta002">
						<div class="form-row mt-3">
						    <input type="hidden" id="txtIDUSR" class="caja-texto" placeholder="Documento Cliente" value="<?php echo $user_sesion; ?>">
						    <div class="col-md">
							...
							<div class="col-md">
								...
								<input type="date" id="txtDesdeFiltro" class="caja-texto" placeholder="Documento Cliente" value="">
							</div>
							<div class="col-md">
								<label class="label-texto">Hasta: </label>
								<input type="date" id="txtHastaFiltro" class="caja-texto" placeholder="Documento Cliente" value="">
							</div>
							...
							<div class="col-md">
								<label class="label-texto">Estado Lote: </label>
							...
							<div class="col-md">
								<label class="label-texto">Estado Validaci&oacute;n : </label>
								<select id="bxFiltroEstadoValidacion" class="cbx-texto">
									<option selected="true" value="">TODOS</option>
									<?php
										$MotivosReporteReserva = new ControllerCategorias();
										$VerMotivosReporteReserva = $MotivosReporteReserva->VerEstadoValidacionDevolucion();
										foreach ($VerMotivosReporteReserva as $ReporteReservas) {
									?>
									<option value="<?php echo $ReporteReservas['ID']; ?>">
									<?php echo $ReporteReservas['Nombre']; ?>
								...
								<table class="table table-striped table-bordered" id="TablaReservasReporte"
									...
									<thead class="cabecera">
										<tr>
											...
											<th>Estado Validaci&oacute;n</th>
										    <th>Fecha Venta</th>
										    <th>Codigo</th>
										    <th>Documento</th>
											<th>Cliente</th>
                        ...
                        <div class="col-md-12" id="PnlLeyenda" style="display: none;">     
                            <br>                       
                            <label class="label-texto">Leyenda : </label>         
                            <div id="PnlEstados">
        ...
        <div class="modal fade justify-content-center" id="modalAdendas" tabindex="-1" role="dialog" data-backdrop="static" aria-labelledby="myModalLabel">
            <?php
            	require_once "pop-up/M03SM03_POPUP_Adenda.php";
            ?>
        </div>
        
        <!-- POP UP VER ADJUNTO -->
        <div class="modal fade justify-content-center" id="modalVerDocumentoDevolucion" tabindex="-1" role="dialog" data-backdrop="static" aria-labelledby="myModalLabel">
            <?php
            	require_once "pop-up/M03SM03_POPUP_VerAdenda.php";
            ?>
        </div>
        <!-- ============================================================== -->
        <!-- End Page wrapper  -->
    ...
    <script src="../../js/M03_Ventas/M03JS03_Devoluciones/M03JS03_Devoluciones.js?v=1.1.1"></script>
