        ...
        <div class="page-wrapper">
            ...
            <div class="breadcrumb-ancho mt-1">
                <ol class="breadcrumb breadcrumb-arrow">
                    ...
                    <li><a class="enlace" href="javascript:void(0)">Refinanciamiento</a></li>
                ...
                <div class="box box-primary">
                    ...
                    <div class="row">
                        <div class="col-md-12" id="contenido_registro" style="display:block;">
                            ...
                            <fieldset>
                                <legend>Datos del Refinanciamiento</legend>
                                <div class="row row-0 reducir" id="formularioDatosTraslado" style="display: none">
                                    <div class="col-md-12 row">
                                        <input  id="_IDAMORTIZACION" type="hidden">

                                        <label class="col-md-1 label-texto-sm">Saldo Pendiente</label>
                                        <div class="col-md-2">
                                            <input class="caja-texto tamano-text-10" id="txtSaldoPendiente" type="text" readonly>
                                        </div>

                                        <label class="col-md-1 label-texto-sm">Letras Pendientes</label>
                                        <div class="col-md-2">
                                            <input class="caja-texto tamano-text-10" id="txtLetrasPendientes" type="text" value="0.00" readonly>
                                        </div>

                                        <label class="col-md-1 label-texto-sm">Nuevas Letras</label>
                                        <div class="col-md-2">
                                            <input class="caja-texto tamano-text-10" id="txtNuevasLetras" type="text">
                                        </div>

                                        <label class="col-md-1 label-texto-sm">TNA(%)</label>
                                        <div class="col-md-2">
                                            <input class="caja-texto tamano-text-10" id="txtTNA" type="text">
                                        </div>                                        
                                    </div>
                                </div>
                                <div class="row row-0 reducir" id="formularioMensajeTraslado">
                                    <label class="color-text">El registro de venta no cuenta con Refinanciamiento.</label>
                                </div>
                            </fieldset>
...
<script src="../../js/M03_Ventas/M03JS06_Refinanciamiento/M03JS06_Refinanciamiento.js?v=1.2.0"></script>
