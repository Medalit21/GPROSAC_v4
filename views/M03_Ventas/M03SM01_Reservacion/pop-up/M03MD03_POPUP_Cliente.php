...
<div class="modal-dialog modal-dialog-scrollable modal-lg modal-dialog-centered justify-content-center" role="document" >
    ...
    <div class="modal-content" >
        <div class="modal-cabecera-list" style="text-align:left;">
            ...
            <span><i class="fa fa-list" aria-hidden="true"></i> Agregar Cliente</span>
        </div>
        <div class="head-model cabecera-modal-accion">
            <button class="btn btn-registro-success" id="btnGuardarCliente"><i class="fa fa-save"></i> Guardar</button>
            <button class="btn btn-registro-primary" id="btnCancelarCliente"><i class="fa fa-minus-circle"></i> Cancelar</button>
        </div>
            ...
            <fieldset>
                    ...
                    <div class="form-row" style="margin-top: -8px;">
                        <div class="col-lg-2 col-md-4">
                            ...
                            <select id="cbxTipoDocumentoAdd" class="cbx-texto">
                        ...
                        <div class="col-lg-2 col-md-4">
                           ...
                           <!--  <input id="txtDocumento" class="caja-texto" maxlength="8" placeholder="# Documento"
                            ...
                            <div class="input-group">
                                <input id="txtDocumentoAdd" class="form-control input-min caja-texto" maxlength="8" placeholder="# Documento" required="">
