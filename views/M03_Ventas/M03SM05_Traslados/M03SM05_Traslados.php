        ...
        <div class="page-wrapper">
            ...
            <div class="breadcrumb-ancho mt-1">
                <ol class="breadcrumb breadcrumb-arrow">
                    ...
                    <li><a class="enlace" href="javascript:void(0)">Traslados</a></li>
            ...
            <div class="container-fluid pt-0">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <input class="caja-texto" id="ValidUsuario" maxlength="15" type="hidden" value="<?php echo $user_sesion; ?>">
                        ...
                        <div class="col-md-12" id="contenido_registro" style="display:block;">
                            ...
                            <div class="col-md-12 row">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <!--<input class="caja-texto" id="txtDocumentoCliente" maxlength="15" type="text" value="" hidden>-->
                            ...
                            <fieldset>
                                ...
                                <div class="row row-0 reducir" id="formularioDatosTraslado" style="display: none">
                                    <div class="col-md-12 row">                                       
                                        <input  id="_IDAMORTIZACION" type="hidden"> 

                                        <label class="col-md-1 label-texto-sm">Proyecto <small id="cbxProyectoHtmlT"
                                            class="form-text text-muted-validacion text-danger ocultar-info">
                                        </small></label>
                                        <div class="col-md-2">
                                            <select id="cbxProyectoT" class="cbx-texto" disabled>
                                                <?php
                                                $verProyecto = new ControllerCategorias();
                                                $verProyectos = $verProyecto->VerProyectos();
                                                foreach ($verProyectos as $item) {
                                        ...
                                        <label class="col-md-1 label-texto-sm">Zona <small id="cbxZonaHtmlT"
                                            class="form-text text-muted-validacion text-danger ocultar-info">
                                        </small></label>
                                        <div class="col-md-2">
                                            <select id="cbxZonaT" class="cbx-texto" disabled>
                                                <option selected="true" value="" disabled="">Seleccionar...</option>}
                                            </select>
                                        </div>
                                        <label class="col-md-1 label-texto-sm">Manzana <small id="cbxManzanaHtmlT"
                                            class="form-text text-muted-validacion text-danger ocultar-info">
                                        </small></label>
                                        <div class="col-md-2">
                                            <select id="cbxManzanaT" class="cbx-texto" disabled>
                                                <option selected="true" value="" disabled="">Seleccionar...</option>}
                                            </select>
                                        </div>
                                        <label class="col-md-1 label-texto-sm">Lote <small id="cbxLoteHtmlT"
                                            class="form-text text-muted-validacion text-danger ocultar-info">
                                        </small></label>
                                        <div class="col-md-2">
                                            <select id="cbxLoteT" class="cbx-texto" disabled>
                                                <option selected="true" value="" disabled="">Seleccionar...</option>}
                                            </select>
                                        </div>
                                        ...
                                        <label class="col-md-1 label-texto-sm">Propiedad</label>
                                        <div class="col-md-2">
                                            <select id="cbxTipoInmueble" class="cbx-texto" disabled>
                                        ...
                                        <div class="col-md-2">
                                            <select id="cbxTipoCasa" class="cbx-texto" disabled>
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-md-2">
                                            <select id="cbxCondicion" class="cbx-texto">
                                        ...
                                        <div class="col-md-2">
                                            <select id="cbxTipoMonedaVenta" class="cbx-texto" disabled>
                                                <option selected="true" value="" disabled="">Seleccione...</option>
                                                <?php
                                        ...
                                        <div class="col-md-2">
                                            <input class="caja-texto tamano-text-10" id="txtTipoCambioT" type="text" value="0.00" disabled>
                                        </div>
                                        
                                        <label class="col-md-1 label-texto-sm">Precio Venta</label>
                                        <div class="col-md-2">
                                            <input class="caja-texto tamano-text-10" id="txtNuevoPrecioVenta" type="text">
                                        </div>

                                        <label class="col-md-1 label-texto-sm">Capital Inicial</label>
                                        <div class="col-md-2">
                                            <input class="caja-texto tamano-text-10" id="txtMontoInicialEntrante" type="text">
                                        </div>                                        

                                        <label class="col-md-1 label-texto-sm">Monto Inicial</label>
                                        <div class="col-md-2">
                                            <input class="caja-texto tamano-text-10" id="txtNuevoMontoInicial" type="text" disabled>
                                        </div>

                                        <label class="col-md-1 label-texto-sm">Total a Financiar</label>
                                        <div class="col-md-2">
                                            <input class="caja-texto tamano-text-10" id="txtNuevoTotalInicial" type="text">
                                        </div>
                                        ...
                                        <label class="col-md-1 label-texto-sm">1era Fecha Pago</label>
                                        <div class="col-md-2">
                                            <input class="caja-texto tamano-text-10" id="txtPrimeraFecha" type="date" disabled>
                                        </div>

                                        <label class="col-md-1 label-texto-sm">TEA %</label>
                                        <div class="col-md-2">
                                            <input class="caja-texto tamano-text-10" id="txtNuevaTEA" type="text" disabled>
                                        </div>

                                        <label class="col-md-1 label-texto-sm">Adjunto</label>
                                        <div class="col-md-5">
                                            <input class="caja-texto tamano-text-10" id="fileContrato" type="file" accept=".pdf">
                                        </div>
                                       

                                    </div>
                                </div>
                                <div class="row row-0 reducir" id="formularioMensajeTraslado">
                                    <label class="color-text">El Lote no registra traslados.</label>
                                </div>
                            </fieldset>
...
<script src="../../js/M03_Ventas/M03JS05_Traslados/M03JS05_Traslados.js?v=1.2.0"></script>
