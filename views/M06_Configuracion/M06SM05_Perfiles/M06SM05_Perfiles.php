...
<body>
        ...
        <div class="page-wrapper">
            ...
            <div class="breadcrumb-ancho">
                <ol class="breadcrumb breadcrumb-arrow">
                    <li><a class="enlace" href="javascript:void(0)">Configuración</a></li>
                    <li><a class="enlace" href="javascript:void(0)">Perfiles</a></li>
                </ol>
            </div>
            <!-- ============================================================== -->
                            ...
                            <fieldset>
                                ...
                                <div id="formularioRegistrarGeneral">
									<div class="form-row" style="margin-top: -8px;" >										
										<div class="col-md-4">
											<label class="label-texto">Nombre Perfil <small id="txtNombrePerfilHtml"
													class="form-text text-muted-validacion text-danger ocultar-info">
												</small></label>
											<input type="text" id="txtNombrePerfil" class="caja-texto"
												placeholder="Escriba nombre" style="text-transform:uppercase;" value=""  onkeyup="javascript:this.value=this.value.toUpperCase();" required>
										</div>
										<div class="col-md-2">
                        ...
                        <div class="fn-frm-dt">
                            ...
                            <div class="table-resp">
                                <div class="table-responsive scroll-table">
                                    <table class="table table-striped table-bordered" id="TablaPerfilesReporte"
                                        style="display: none;">
                                    ...
                                    <table id="TablaPerfiles" class="table table-striped table-bordered table-hover w-100">
                                        <thead class="cabecera">
                                            <tr>
                                                <th scope="col"></th>
                                                <th scope="col">N°</th>
    ...
    <script src="../../js/M06_Configuracion/M06JS05_Perfiles/M06JS05_index.js?v=1.1.1"></script>
