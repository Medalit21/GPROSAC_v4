...
<head>
    ...
    <!-- Favicon icon -->
    <title><?php echo $NAME_APP.' - Reporte de Ventas'; ?></title>
...
<body>
					...
					<div id="BusquedaVenta002">
						<div class="form-row mt-3">
							...
							<div class="col-md">
								...
								<input type="date" id="txtDesdeFiltroV" class="caja-texto"
									placeholder="Documento Cliente" value="">
							</div>
							<div class="col-md">
								<label class="label-texto">Hasta: </label>
								<input type="date" id="txtHastaFiltroV" class="caja-texto"
									placeholder="Documento Cliente" value="">
							</div>
							<div class="col-md">
    ...
    <script src="../../js/M05_Reportes/M05JS02_Ventas/M05JS02_Ventas.js?v=1.1.1"></script>
