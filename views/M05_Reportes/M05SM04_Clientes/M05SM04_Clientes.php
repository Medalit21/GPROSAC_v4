...
<head>
    ...
    <!-- Favicon icon -->
    <title><?php echo $NAME_APP.' - Reporte de Propietarios'; ?></title>
...
<body class="fond-back">
        ...
        <div class="page-wrapper fond-back">
            ...
            <div class="breadcrumb-ancho">
                <ol class="breadcrumb breadcrumb-arrow">
                    ...
                    <li><a class="enlace" href="javascript:void(0)">Propietarios</a></li>
                </ol>
            </div>
            <!-- ============================================================== -->
					...
					<div id="BusquedaRegistro">
						<div class="form-row mt-3">
							...
							<div class="col-md">
                                ...
                                <select id="bxFiltroProyectoPropietarios" class="cbx-texto">
                            ...
                            <div class="col-md">
                                ...
                                <select id="bxFiltroZonaPropietarios" class="cbx-texto">
                                    <option selected="true" value="0">TODOS</option> 
                                </select>
                            </div>
                            <div class="col-md">
                                <label class="label-texto">Manzana </label>
                                <select id="bxFiltroManzanaPropietarios" class="cbx-texto">
                            ...
                            <div class="col-md">
                                ...
                                <select id="bxFiltroLotePropietarios" class="cbx-texto">
                                    <option selected="true" value="0" disabled="disabled">TODOS</option>
                                </select>
                            </div>
                            <div class="col-md">
                                <label class="label-texto">Estado </label>
                                <select id="bxFiltroEstadoPropietarios" class="cbx-texto">
                                    <option selected="true" value="">TODOS</option>
                                    <?php
                                        $Lotes = new ControllerCategorias();
                                        $EstadoLotes = $Lotes->VerEstadosReportePropietarios();
						...
						<div class="fn-frm-dt">
							<div class="table-responsive scroll-table">
								<table class="table table-striped table-bordered" id="TablaClienteReporte"
									style="display: none;">
    ...
    <script src="../../js/M05_Reportes/M05JS04_Clientes/M05JS04_Clientes.js?v=1.1.1"></script>
