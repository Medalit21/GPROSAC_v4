...
<head>
    ...
    <!-- Favicon icon -->
    <title><?php echo $NAME_APP.' - REPORTE DE PAGOS'; ?></title>
...
<body class="fond-back">
        ...
        <div class="page-wrapper fond-back">
            ...
            <div class="breadcrumb-ancho">
                <ol class="breadcrumb breadcrumb-arrow">
                    ...
                    <li><a class="enlace" href="javascript:void(0)">Pagos</a></li> 
                </ol>
            </div>
            <!-- ============================================================== -->
            ...
            <div class="container-fluid">
                ...
                <div class="box box-primary">
                    <div class="row">
                        ...
                        <div class="col-md"><br>
                            <label class="label-texto">Inicio </label>
                            <input type="date" id="txtFiltroFechaInicio" class="caja-texto" value="<?php echo $primer_dia; ?>">
                        </div>
                        
                        <div class="col-md"><br>
                            <label class="label-texto">Fin </label>
                            <input type="date" id="txtFiltroFechaFin" class="caja-texto" value="<?php echo $ultimo_dia; ?>">
                        </div>
                    ...
                    <div class="form-row d-flex justify-content-center">
                        <div class="col-md-6 text-center mt-1">
                            ...
                            <button id="btReporteExcel" type="button" class="btn btn-registro-success" hidden><i class="fas fa-file-excel"></i> Excel</button>
                        </div>
                    </div>
                </div>
                 <!-- editor -->
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div id="editor">   
                                    <div class="form-row">
                                        <div class="col-md">
                                            <input type="text" class="form-control text-cronograma-1" id="TXT122" value="TOTALES" readonly>
                                        </div>
                                        <div class="col-md">
                                            <input type="text" class="form-control text-cronograma-1" id="TXT13" value="LETRAS PAGADAS" readonly>
                                        </div>
                                        <div class="col-md">
                                            <input type="text" class="form-control text-cronograma-1" id="TXT14" value="LETRAS VENCIDAS" readonly>
                                        </div>
                                        <div class="col-md">
                                            <input type="text" class="form-control text-cronograma-1" id="TXT15" value="LETRAS PENDIENTES" readonly>
                                        </div>
                                        <div class="col-md">
                                            <input type="text" class="form-control text-cronograma-1" id="TXT16" value="TOTAL LETRAS" readonly>
                                        </div>
                                    </div>
									
                                    <div class="form-row">
                                        <div class="col-md">
                                            <input type="text" class="form-control text-cronograma" id="TXT17" value="ACUMULADO" readonly>
                                        </div>
                                        <div class="col-md">
                                            <input type="text" class="form-control text-cronograma" id="TXT18" placeholder="LETRAS PAGADAS: 0.00" readonly>
                                        </div>
                                        <div class="col-md">
                                            <input type="text" class="form-control text-cronograma" id="TXT19" placeholder="LETRAS VENCIDAS: 0.00" readonly>
                                        </div>
                                        <div class="col-md">
                                            <input type="text" class="form-control text-cronograma" id="TXT20" placeholder="LETRAS PENDIENTES: 0.00" readonly>
                                        </div>
                                        <div class="col-md">
                                            <input type="text" class="form-control text-cronograma" id="TXT21" placeholder="LETRAS PENDIENTES: 0.00" readonly>
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="col-md">
                                            <input type="text" class="form-control text-cronograma" id="TXT22" value="MES ACTUAL" readonly>
                                        </div>
                                        <div class="col-md">
                                            <input type="text" class="form-control text-cronograma" id="TXT23" placeholder="LETRAS PAGADAS: 0.00" readonly>
                                        </div>
                                        <div class="col-md">
                                            <input type="text" class="form-control text-cronograma" id="TXT24" placeholder="LETRAS VENCIDAS: 0.00" readonly>
                                        </div>
                                        <div class="col-md">
                                            <input type="text" class="form-control text-cronograma" id="TXT25" placeholder="LETRAS PENDIENTES: 0.00" readonly>
                                        </div>
                                        <div class="col-md">
                                            <input type="text" class="form-control text-cronograma" id="TXT26" placeholder="LETRAS PENDIENTES: 0.00" readonly>
                                        </div>
                                    </div>
                                </div>
                                <br><br>
                                <!-- TABLA CONTENEDORA DE REGISTRO DE TRABAJADORES -->
                                <div class="fn-frm-dt" style="margin-top: -20px">                                  
    ...
    <script src="../../js/M05_Reportes/M05JS08_Pagos/M05JS08_Pagos.js?v=1.1.1"></script>
