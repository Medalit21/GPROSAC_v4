                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <center><label style="font-size: 18px; text-align: center; font-weight: bold;">REPORTE DE VENTAS - RESUMEN - <?php echo $valor; ?></label></center>
                                <br>
                                ...
                                <?php 
                                 ...
                                 $query_ventas = mysqli_query($conection, "SELECT 
                                    ...
                                    concat(SUBSTRING_INDEX(per.nombre,' ',1),' ',SUBSTRING_INDEX(per.apellido,' ',1)) as nom_vendedor,
                                    gpv.fecha_venta as fecha,
                                    concat(dc.apellido_paterno,' ',dc.apellido_materno,' ',dc.nombres) as cliente,
                                    cdx.texto1 as tipo_moneda,
                                    concat(gpp.nombre,' - ',gpz.nombre) as proyecto,
                                    concat(SUBSTRING(gpm.nombre,9,2), ' - ',SUBSTRING(gpl.nombre,6,2)) as lote,
                                    FORMAT(SUM(gpv.total + ROUND((gpv.total * (gpv.tna/100)),2)),2) as total,
                                    FORMAT(SUM((SELECT SUM(gppd.importe_pago) FROM gp_pagos_detalle gppd WHERE gppd.id_venta=gpv.id_venta)),2) as monto_pagado,
                                    FORMAT(SUM((SELECT SUM(gpcr.monto_letra) FROM gp_cronograma gpcr WHERE gpcr.id_venta=gpv.id_venta AND gpcr.estado=1)),2) as saldo,
                                    FORMAT(SUM(gpv.monto_cuota_inicial),2) as monto_inicial,
                                    FORMAT(SUM((SELECT SUM(gppd1.importe_pago) FROM gp_pagos_detalle gppd1 WHERE gppd1.id_venta=gpv.id_venta AND gppd1.estado=2 AND MONTH(gppd1.fecha_pago)='1' AND YEAR(gppd1.fecha_pago)='$valor')),2) as enero,
                                    FORMAT(SUM((SELECT SUM(gppd1.importe_pago) FROM gp_pagos_detalle gppd1 WHERE gppd1.id_venta=gpv.id_venta AND gppd1.estado=2 AND MONTH(gppd1.fecha_pago)='2' AND YEAR(gppd1.fecha_pago)='$valor')),2) as febrero,
                                    FORMAT(SUM((SELECT SUM(gppd1.importe_pago) FROM gp_pagos_detalle gppd1 WHERE gppd1.id_venta=gpv.id_venta AND gppd1.estado=2 AND MONTH(gppd1.fecha_pago)='3' AND YEAR(gppd1.fecha_pago)='$valor')),2) as marzo,
                                    FORMAT(SUM((SELECT SUM(gppd1.importe_pago) FROM gp_pagos_detalle gppd1 WHERE gppd1.id_venta=gpv.id_venta AND gppd1.estado=2 AND MONTH(gppd1.fecha_pago)='4' AND YEAR(gppd1.fecha_pago)='$valor')),2) as abril,
                                    FORMAT(SUM((SELECT SUM(gppd1.importe_pago) FROM gp_pagos_detalle gppd1 WHERE gppd1.id_venta=gpv.id_venta AND gppd1.estado=2 AND MONTH(gppd1.fecha_pago)='5' AND YEAR(gppd1.fecha_pago)='$valor')),2) as mayo,
                                    FORMAT(SUM((SELECT SUM(gppd1.importe_pago) FROM gp_pagos_detalle gppd1 WHERE gppd1.id_venta=gpv.id_venta AND gppd1.estado=2 AND MONTH(gppd1.fecha_pago)='6' AND YEAR(gppd1.fecha_pago)='$valor')),2) as junio,
                                    FORMAT(SUM((SELECT SUM(gppd1.importe_pago) FROM gp_pagos_detalle gppd1 WHERE gppd1.id_venta=gpv.id_venta AND gppd1.estado=2 AND MONTH(gppd1.fecha_pago)='7' AND YEAR(gppd1.fecha_pago)='$valor')),2) as julio,
                                    FORMAT(SUM((SELECT SUM(gppd1.importe_pago) FROM gp_pagos_detalle gppd1 WHERE gppd1.id_venta=gpv.id_venta AND gppd1.estado=2 AND MONTH(gppd1.fecha_pago)='8' AND YEAR(gppd1.fecha_pago)='$valor')),2) as agosto,
                                    FORMAT(SUM((SELECT SUM(gppd1.importe_pago) FROM gp_pagos_detalle gppd1 WHERE gppd1.id_venta=gpv.id_venta AND gppd1.estado=2 AND MONTH(gppd1.fecha_pago)='9' AND YEAR(gppd1.fecha_pago)='$valor')),2) as septiembre,
                                    FORMAT(SUM((SELECT SUM(gppd1.importe_pago) FROM gp_pagos_detalle gppd1 WHERE gppd1.id_venta=gpv.id_venta AND gppd1.estado=2 AND MONTH(gppd1.fecha_pago)='10' AND YEAR(gppd1.fecha_pago)='$valor')),2) as octubre,
                                    FORMAT(SUM((SELECT SUM(gppd1.importe_pago) FROM gp_pagos_detalle gppd1 WHERE gppd1.id_venta=gpv.id_venta AND gppd1.estado=2 AND MONTH(gppd1.fecha_pago)='11' AND YEAR(gppd1.fecha_pago)='$valor')),2) as noviembre,
                                    FORMAT(SUM((SELECT SUM(gppd1.importe_pago) FROM gp_pagos_detalle gppd1 WHERE gppd1.id_venta=gpv.id_venta AND gppd1.estado=2 AND MONTH(gppd1.fecha_pago)='12' AND YEAR(gppd1.fecha_pago)='$valor')),2) as diciembre
                                    FROM gp_venta gpv
                                    ...
                                    WHERE gpv.esta_borrado=0 AND YEAR (gpv.fecha_venta) = '$valor'
                                    GROUP BY vendedor, cliente WITH ROLLUP 
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered" cellspacing="0" id="TablaHojaResumen" style="width: 100%; text-align: center;">
                                            <thead class="cabecera">
                                                <tr>
                                                    <th style="font-size: 13px;width: 120px">Vendedor</th>
                                                    <th style="font-size: 13px;width: 60px">Fecha</th>
                                                    <th style="font-size: 13px;width: 220px">Cliente</th>
                                                    <th style="font-size: 13px;width: 20px"></th>
                                                    <th style="font-size: 13px;width: 100px">Proyecto</th>
                                                    <!--<th style="font-size: 13px">Zona</th>-->
                                                    <th style="font-size: 13px;width: 40px">Lote</th>
                                                    <th style="font-size: 13px">Total Venta</th>
                                                    <th style="font-size: 13px">Monto Pagado</th>
                                                    <th style="font-size: 13px;background-color: red; color: white;">Saldo</th> 
                                                    <th style="font-size: 13px;background-color: #FF9531; color: white;">Monto Inicial</th> 
                                                    <th style="font-size: 13px">Ene</th>
                                                    <th style="font-size: 13px">Feb</th> 
                                                    <th style="font-size: 13px">Mar</th> 
                                                    <th style="font-size: 13px">Abr</th> 
                                                    <th style="font-size: 13px">May</th> 
                                                    <th style="font-size: 13px">Jun</th> 
                                                    <th style="font-size: 13px">Jul</th> 
                                                    <th style="font-size: 13px">Ago</th> 
                                                    <th style="font-size: 13px">Sep</th> 
                                                    <th style="font-size: 13px">Oct</th> 
                                                    <th style="font-size: 13px">Nov</th>
                                                    <th style="font-size: 13px">Dic</th>    
                                                </tr>
                                            </thead>
                                            <tbody class="control-detalle">
                                                <?php while($row = $query_ventas->fetch_assoc()){  
                                                    ...
                                                    $dato_6=$row['lote'];
                                                    $accion = 0;
                                                    $forma_1=""; $forma_2=""; $forma_3=""; $forma_4=""; $forma_5=""; $forma_6=""; $forma_7=""; $forma_8=""; $forma_9=""; $forma_10=""; $forma_11=""; $forma_12=""; $forma_13="";

                                                    if(!empty($row['enero'])){
                                                        $forma_2="background-color: #91FF88";
                                                    }else{ $forma_2="";}

                                                    if(!empty($row['febrero'])){
                                                        $forma_3="background-color: #91FF88";
                                                    }else{ $forma_3="";}

                                                     if(!empty($row['marzo'])){
                                                        $forma_4="background-color: #91FF88";
                                                    }else{ $forma_4="";}

                                                     if(!empty($row['abril'])){
                                                        $forma_5="background-color: #91FF88";
                                                    }else{ $forma_5="";}

                                                     if(!empty($row['mayo'])){
                                                        $forma_6="background-color: #91FF88";
                                                    }else{ $forma_6="";}

                                                     if(!empty($row['junio'])){
                                                        $forma_7="background-color: #91FF88";
                                                    }else{ $forma_7="";}

                                                     if(!empty($row['julio'])){
                                                        $forma_8="background-color: #91FF88";
                                                    }else{ $forma_8="";}

                                                     if(!empty($row['agosto'])){
                                                        $forma_9="background-color: #91FF88";
                                                    }else{ $forma_9="";}

                                                     if(!empty($row['septiembre'])){
                                                        $forma_10="background-color: #91FF88";
                                                    }else{ $forma_10="";}

                                                     if(!empty($row['octubre'])){
                                                        $forma_11="background-color: #91FF88";
                                                    }else{ $forma_11="";}

                                                     if(!empty($row['noviembre'])){
                                                        $forma_12="background-color: #91FF88";
                                                    }else{ $forma_12="";}

                                                     if(!empty($row['diciembre'])){
                                                        $forma_13="background-color: #91FF88";
                                                    }else{ $forma_13="";}
                                                    ...
                                                    if(empty($valida_1) && !empty($valida_2)){
                                                        ...
                                                        $dato_6="";
                                                        $accion = 2;
                                                        $forma_1='style="background-color: #E5E5E5;color: black; font-weight: bold"';
                                                        $forma_2=""; $forma_3=""; $forma_4=""; $forma_5=""; $forma_6=""; $forma_7=""; $forma_8=""; $forma_9=""; $forma_10=""; $forma_11=""; $forma_12=""; $forma_13="";
                                                        ...
                                                        if(empty($valida_1) && empty($valida_2)){
                                                            ...
                                                            $dato_6="";
                                                            $accion = 3;
                                                            $forma_1='style="background-color: #F9FF83;color: black; font-weight: bold"';
                                                            $forma_2=""; $forma_3=""; $forma_4=""; $forma_5=""; $forma_6=""; $forma_7=""; $forma_8=""; $forma_9=""; $forma_10=""; $forma_11=""; $forma_12=""; $forma_13="";
                                                        }
                                                    }
                                                    ?>
                                                <tr <?php echo $forma_1; ?>>
                                                    <td style="text-align: left;"><?php echo $dato_1; ?></td>
                                                    <td><?php echo $dato_2; ?></td>
                                                    <td style="text-align: left;"><?php echo $row['cliente']; ?></td>
                                                    <td><?php echo $dato_3; ?></td>
                                                    <td><?php echo $dato_4; ?></td>
                                                    <!--<td><?php //echo $dato_5; ?></td>-->
                                                    <td><?php echo $dato_6; ?></td>
                                                    <td style="font-size: 12px"><?php echo $row['total']; ?></td>
                                                    <td style="font-size: 12px;color: blue"><?php echo $row['monto_pagado']; ?></td>
                                                    <td style="font-size: 12px;color: red"><?php echo $row['saldo']; ?></td>
                                                    <td style="font-size: 12px;color: #DF6C00"><?php echo $row['monto_inicial']; ?></td>
                                                    <td style="font-size: 12px;<?php echo $forma_2; ?>"><?php echo $row['enero']; ?></td>
                                                    <td style="font-size: 12px;<?php echo $forma_3; ?>"><?php echo $row['febrero']; ?></td>
                                                    <td style="font-size: 12px;<?php echo $forma_4; ?>"><?php echo $row['marzo']; ?></td>
                                                    <td style="font-size: 12px;<?php echo $forma_5; ?>"><?php echo $row['abril']; ?></td>
                                                    <td style="font-size: 12px;<?php echo $forma_6; ?>"><?php echo $row['mayo']; ?></td>
                                                    <td style="font-size: 12px;<?php echo $forma_7; ?>"><?php echo $row['junio']; ?></td>
                                                    <td style="font-size: 12px;<?php echo $forma_8; ?>"><?php echo $row['julio']; ?></td>
                                                    <td style="font-size: 12px;<?php echo $forma_9; ?>"><?php echo $row['agosto']; ?></td>
                                                    <td style="font-size: 12px;<?php echo $forma_10; ?>"><?php echo $row['septiembre']; ?></td>
                                                    <td style="font-size: 12px;<?php echo $forma_11; ?>"><?php echo $row['octubre']; ?></td>
                                                    <td style="font-size: 12px;<?php echo $forma_12; ?>"><?php echo $row['noviembre']; ?></td>
                                                    <td style="font-size: 12px;<?php echo $forma_13; ?>"><?php echo $row['diciembre']; ?></td>
                                                </tr>
                                                <?php  } ?>
                                            </tbody>
                                        </table>
