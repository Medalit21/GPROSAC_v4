...
<body class="fond-back">
    ...
    <?php
		...
		//require_once "../../../controllers/ControllerExportar.php";
        ...
        <div class="page-wrapper fond-back">
            ...
            <div class="breadcrumb-ancho">
                <ol class="breadcrumb breadcrumb-arrow">
                    ...
                    <li><a class="enlace" href="M02SM03_CronogramaMasivo.php?Vsr=<?php echo $user_sesion; ?>">Cronogramas Masivo</a></li>
                </ol>
            </div>
            <!-- ============================================================== -->
                    ...
                    <div class="form-row d-flex justify-content-center">
                        <div class="col-md-12 text-center mt-1" id="PanelBotons">
                            ...
                            <button id="btnLimpiarFiltros" type="button" class="btn btn-registro-primary"><i class="fas fa-sync-alt"></i> Limpiar</button>
							 <!------------------ FORMULARIO REPORTE ----------------------->
							<form id="formExportarExcel" method="POST" action="../../../controllers/ControllerExcel.php" target="_blank">
								<input type="hidden" name="btnExportarExcel" value="true">
								<input type="hidden" name="txtFiltroDocumentoCP">
								<input type="hidden" name="bxFiltroProyectoCP">
								<input type="hidden" name="bxFiltroZonaCP">
								<input type="hidden" name="bxFiltroManzanaCP">
								<input type="hidden" name="bxFiltroLoteCP">
								<input type="hidden" name="bxFiltroEstadoCP">  
							</form>

							<button id="btnIrReporte" type="button" class="btn btn-registro-success">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div id="editor">                                   
                                    ...
                                    <div class="form-row">
                                        <diV class="col-md">
                                            <label type="text" class="form-control text-cronograma" id="TXT_CANT_VENTAS">CANTIDAD DE VENTAS : 0</label>
                                        </diV>
                                        <diV class="col-md">
                                            <label type="text" class="form-control text-cronograma" id="TXT_TOT_VENTAS">TOTAL VENTAS : $ 0.00</label>
                                        </diV>
                                        <diV class="col-md">
                                            <label type="text" class="form-control text-cronograma" id="TXT_TOT_INTERESES">TOTAL INTERESES : $ 0.00</label>
                                        </diV>
                                        
                                    </div>
                                    <div class="form-row">
                                        <diV class="col-md">
                                            <label type="text" class="form-control text-cronograma" id="TXT_TOT_FINANCIADO">TOTAL FINANCIADO : $ 0.00</label>
                                        </diV>
                                        <diV class="col-md">
                                            <label type="text" class="form-control text-cronograma" id="TXT_TOT_PAGADO">TOTAL PAGADO : $ 0.00</label>
                                        </diV>
                                        <diV class="col-md">
                                            <label type="text" class="form-control text-cronograma" id="TXT_TOT_PENDIENTE">TOTAL PENDIENTE : $ 0.00</label>
                                        </diV>
    ...
    <script src="../../js/M05_Reportes/M05JS16_CronogramaPagos/M05JS16_CronogramaMasivo.js?v=1.1.1"></script>
