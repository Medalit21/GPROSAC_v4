...
<body class="fond-back">
        ...
        <div class="page-wrapper fond-back">
            ...
            <div class="breadcrumb-ancho">
                <ol class="breadcrumb breadcrumb-arrow">
                    ...
                    <li><a class="enlace" href="javascript:void(0)">Pagos General</a></li> 
                </ol>
            </div>
            <!-- ============================================================== -->
                ...
                <div class="box box-primary">
                    ...
                    <div class="form-row d-flex justify-content-center">
                        <div class="col-md-6 text-center mt-1">
                            <button id="btnBuscarPago" type="button" class="btn btn-registro-success"><i class="fas fa-search"></i> Buscar</button>
                            <button id="btnLimpiarPago" type="button" class="btn btn-registro-primary"><i class="fas fa-sync-alt"></i> Limpiar</button>
                        </div>
                    </div>
                </div>
                 <!-- editor -->
    ...
    <script src="../../js/M05_Reportes/M05JS10_PagosGeneral/M05JS10_PagosGeneral.js?v=1.1.1"></script>
