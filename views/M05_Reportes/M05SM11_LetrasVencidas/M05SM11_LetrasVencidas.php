...
<head>
    ...
    <!-- Favicon icon -->
    <title><?php echo $NAME_APP.' - Reporte Letras Vencidas'; ?></title>
...
<body class="fond-back">
        ...
        <div class="page-wrapper fond-back">
            ...
            <div class="breadcrumb-ancho">
                <ol class="breadcrumb breadcrumb-arrow">
                    ...
                    <li><a class="enlace" href="javascript:void(0)">Letras por Estado</a></li>
                </ol>
            </div>
            <!-- ============================================================== -->
                            ...
                            <div id="BusquedaRegistro">
                                ...
                                <div class="form-row d-flex justify-content-center">
                                    <div class="col-md-4 text-center mt-1">
                                        ...
                                        <button class="btn btn-registro-danger" id="btnReporte" name="btnReporte"><i class="fas fa-file-pdf"></i> Reporte</button>
                                    </div>
                                </div>
                                <hr>
                                <div class="row">
                                    <div class="col-md-2">
                                        <label class="form-control text-right text-res">TOTAL LETRAS</label>
                                    </div>
                                    <div class="col-md-2">
                                        <input type="text" id="txtTotalLetras" class="form-control inp-res" value="0.00" readonly>
                                    </div>
                                    <div class="col-md-2">
    ...
    <script src="../../js/M05_Reportes/M05JS11_LetrasVencidas/M05JS11_LetrasVencidas.js?v=1.1.1"></script>
