        ...
        <div class="page-wrapper">
            ...
            <div class="breadcrumb-ancho">
                <ol class="breadcrumb breadcrumb-arrow">
                    ...
                    <li><a class="enlace" href="javascript:void(0)">Indicadores</a></a></li>
                </ol>
            </div>
            <!-- ============================================================== -->
            ...
            <div class="container-fluid">
                <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" href="#reporte001" role="tab" data-toggle="tab">Ventas Mensuales Tipo Inmueble</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#reporte002" role="tab" data-toggle="tab">Ventas Mensuales Tipo Casa</a>
                    </li>
                </ul>
                            ...
                            <div id="BusquedaRegistro">
                                ...
                                <div class="form-row mt-3">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <button class="btn btn-registro-primary" id="btnLimpiar" name="btnLimpiarClient1" style="margin-top: 15px">
                                            <i class="fas fa-sync-alt"></i> Limpiar
                                        </button>
                                        <button id="btnExportarPdf" class="btn btn-registro-danger" style="margin-top: 15px" hidden><i class="fas fa-file-pdf" style="color:white"></i> Reporte</button>
                                    </div>
                            ...
                            <div id="BusquedaRegistro">
                                <div class="form-row mt-3">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <button class="btn btn-registro-primary" id="btnLimpiar2" name="btnLimpiarClient2" style="margin-top: 15px">
                                            <i class="fas fa-sync-alt"></i> Limpiar
                                        </button>
                                        <button id="btnExportarPdf2" class="btn btn-registro-danger" style="margin-top: 15px" hidden><i class="fas fa-file-pdf" style="color:white"></i> Reporte</button>
                                    </div>
                                </div>
                                <br>
                                <div class="col-md-12" style="width: 100%">
