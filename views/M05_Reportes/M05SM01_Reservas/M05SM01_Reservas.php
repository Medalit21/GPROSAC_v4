...
<head>
    ...
    <!-- Favicon icon -->
    <title><?php echo $NAME_APP.' - Reporte de Reservas'; ?></title>
...
<body class="fond-back">
        ...
        <div class="page-wrapper fond-back">
            ...
            <div class="breadcrumb-ancho">
                <ol class="breadcrumb breadcrumb-arrow">
                    ...
                    <li><a class="enlace" href="javascript:void(0)">Reservas</a></li>
                </ol>
            </div>
            <!-- ============================================================== -->
                            ...
                            <div id="BusquedaRegistro">
                                <div class="form-row mt-3">
									...
									<div class="col-md" hidden>
										...
										<select id="bxFiltroEstado" class="cbx-texto">
											<?php
												...
												$VerEstadoReserva = $EstadoReserva->VerEstadosReporteReservas();
									...
									<div class="col-md">
										...
										<select id="bxFiltroMotivo" class="cbx-texto">
											<option selected="true" value="">TODOS</option>
											<?php
												$MotivosReporteReserva = new ControllerCategorias();
												$VerMotivosReporteReserva = $MotivosReporteReserva->VerMotivosReporteReservas();
									...
									<div class="col-md">
										<label class="label-texto">Medio : </label>
										<select id="bxFiltroMedio" class="cbx-texto">
											<option selected="true" value="">TODOS</option>
											<?php
												$MedioCaptacion = new ControllerCategorias();
											$VerMedioCaptacion = $MedioCaptacion->VerMedioCaptaciones();
												foreach ($VerMedioCaptacion as $MediosC) {
											?>
											<option value="<?php echo $MediosC['ID']; ?>">
											<?php echo $MediosC['Nombre']; ?>
											</option>
											<?php } ?>
										</select>
									</div>
    ...
    <script src="../../js/M05_Reportes/M05JS01_Reservas/M05JS01_Reservas.js?v=1.1.1"></script>
