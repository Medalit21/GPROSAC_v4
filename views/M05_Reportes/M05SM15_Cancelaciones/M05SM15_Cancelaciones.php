        ...
        <div class="page-wrapper">
            ...
            <div class="breadcrumb-ancho mt-1">
                <ol class="breadcrumb breadcrumb-arrow">
                    ...
                    <li><a class="enlace" href="javascript:void(0)">Cancelaciones</a></li>
                        ...
                        <div class="form-row mt-3">
                            ...
                            <div class="col-md">
                                ...
                                <select id="cbxFiltroEstado" class="cbx-texto">
                                    <option selected="true" value="todos" disabled="disabled">TODOS</option>
...
<script src="../../js/M05_Reportes/M05JS15_Cancelaciones/M05JS15_Cancelaciones.js?v=1.2.0"></script>
