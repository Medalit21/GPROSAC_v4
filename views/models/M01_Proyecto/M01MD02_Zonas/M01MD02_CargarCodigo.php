...
if (!empty($_POST)) {
    if (isset($_POST['btnCargarCodigoZona'])) {
        ...
        $consultar_Correproyecto = mysqli_query($conection, "SELECT max(correlativo) as correlativo FROM gp_zona WHERE estado='1' AND idproyecto='$txtidProyector'");
        ...
        $query = mysqli_query($conection, "SELECT nombre_corto as sigla FROM configuracion_detalle WHERE codigo_tabla='_SIGLA' AND nombre_largo='ZONA'");
