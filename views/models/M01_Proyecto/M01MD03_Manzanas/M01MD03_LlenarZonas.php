<?php
   ...
   $data = array();
    ...
    if(isset($_POST['LlenarZonas'])){
        ...
        $txtidProyectoz = $_POST['txtidProyectoz'];   

        $query = mysqli_query($conection, "SELECT idzona as id, nombre as nombre FROM gp_zona WHERE idproyecto='$txtidProyectoz' order by nombre");
