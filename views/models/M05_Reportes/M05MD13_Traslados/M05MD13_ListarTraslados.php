...
if(!empty($_POST)){
    ...
    $query = mysqli_query($conection,"SELECT 
        ...
        concat(gpzx.nombre,' - ',SUBSTRING(gpmx.nombre,9,2), ' - ',SUBSTRING(gplx.nombre,6,2)) as lote_anterior,
        ...
        FROM gp_traslado gptr
        INNER JOIN gp_venta AS gpv ON gpv.id_venta=gptr.id_venta
        ...
        INNER JOIN gp_lote AS gplx ON gplx.idlote=gptr.id_lote
        INNER JOIN gp_manzana AS gpmx ON gpmx.idmanzana=gplx.idmanzana
        INNER JOIN gp_zona AS gpzx ON gpzx.idzona=gpmx.idzona
    ...
    if($query->num_rows > 0){
        ...
        while($row = $query->fetch_assoc()) {
            ...
            array_push($dataList,[
                ...
                'lote_anterior' => $row['lote_anterior'],
